...
cliner train "$CLINER_DIR/examples/*.xml" --format xml
...
cliner evaluate "$CLINER_DIR/examples/pretend.txt" --gold $CLINER_DIR/examples --predictions $CLINER_DIR/data/test_predictions/ --format xml
